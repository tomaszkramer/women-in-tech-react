...
class ArticleFrameLeft extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        return(
            <div className = 'container-fluid'>
                <div className = 'my-2 d-flex flex-column-reverse flex-lg-row'>
                    ...
                    <div className = {this.props.classColRight}>
                        <img className = 'w-100 h-100 articleFrameLeft--img' src = {require(`${this.state.imgPath}${this.props.srcImg}`)} alt = ''></img>
...
export default ArticleFrameLeft;